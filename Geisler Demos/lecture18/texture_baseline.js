...
async function loadImageFiles() {
    ...
    g_cubeImage.src = "resources/cube.png"
...
async function loadGLSLFiles() {
    g_vshader = await fetch('/texture_baseline.vert').then(response => response.text()).then((x) => x)
    g_fshader = await fetch('/texture_baseline.frag').then(response => response.text()).then((x) => x)
