...
async function loadGLSLFiles() {
    ...
    g_vshaderLighting = await fetch('./shadow_light.vert').then(response => response.text()).then((x) => x)
    g_fshaderLighting = await fetch('./shadow_light.frag').then(response => response.text()).then((x) => x)
